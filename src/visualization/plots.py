...
for name, scores in models_scores.items():
    ...
    plt.plot(
        fpr, tpr,
        linewidth=3 if "CNN" in name else 2.5,
...
plt.savefig(PLOT_DIR / "roc_curve_subjectwise.png", dpi=600, bbox_inches="tight")
plt.close()
...
plt.savefig(PLOT_DIR / "pr_curve_subjectwise.png", dpi=600, bbox_inches="tight")
plt.close()
...
plt.savefig(PLOT_DIR / "accuracy_f1_comparison.png", dpi=600, bbox_inches="tight")
plt.close()
...
plt.savefig(PLOT_DIR / "roc_auc_comparison.png", dpi=600, bbox_inches="tight")
plt.close()
